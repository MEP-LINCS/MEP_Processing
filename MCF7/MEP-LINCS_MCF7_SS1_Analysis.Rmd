...
fullBio <- fullBio[,grep("[.](1|2)|Cells|Cytoplasm.*Dapi|Cytoplasm.*Area|CellMask|Center|Nuclei.*KRT|_SE|Euler|_2N", colnames(fullBio), value = TRUE, invert = TRUE), with = FALSE]
