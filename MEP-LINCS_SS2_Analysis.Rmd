...
#TODO:Analyze why there is a peak around -.7

p <- ggplot(l4F, aes(x=Nuclei_PA_Gated_EduPositiveProportion_RZSNorm))+geom_bar(binwidth = .01)+
...
#TODO: Troubleshoot bug in DNA proportion calculation
fvDT <- fvDT[,DNA2NProportion := NULL]
