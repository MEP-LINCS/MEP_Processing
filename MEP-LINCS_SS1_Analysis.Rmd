...
fv <- grep("Norm", fv, value = TRUE, invert = TRUE)
...
heatmap.2(activeFVM,scale="column", col = bluered, trace = "none", cexRow=.5, cexCol=.7, key=FALSE, main = paste("Active MEP Feature Vectors"), mar = c(15, 13))
...
#Cluster the active MEPs, scaling the inputs
heatmap.2(activeFVMF,scale="column", col = bluered, trace = "none", cexRow=.5, cexCol=.7, key=FALSE, main = paste("Active MEP Feature Vectors (no NID1)"), mar = c(15, 13))
