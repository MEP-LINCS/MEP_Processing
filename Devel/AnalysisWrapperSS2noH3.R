...
renderAnalysisReports <- function(x){
  ...
  render("MEP-LINCS_SS2noH3_SCCHeatmap.Rmd",
         output_file = paste0("./AnalysisReports/MEP-LINCS_Analysis_SS2noH3_SCCHeatmap.html"),
         output_format = "html_document")
}

tmp <- apply(ssDatasets[c(4),], 1, renderAnalysisReports)
