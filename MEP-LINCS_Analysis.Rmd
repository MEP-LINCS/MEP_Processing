...
p <- ggplot(l4HF, aes(x =reorder(MEP, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm), y = Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm))+
  geom_errorbar(aes(ymin=Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm-Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm_SE, ymax=Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm+Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm_SE), width=.01) +
