...
p <- ggplot(dt, aes(x=Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm))+geom_bar(binwidth = .0015)+
...
p <- ggplot(dt, aes(x = reorder(Ligand, Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm, FUN=median), y = Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm, colour = Barcode))+geom_boxplot()+
...
p <- ggplot(dt, aes(x = reorder(ECMpAnnotID, Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm, FUN=median), y = Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm))+geom_boxplot()+
...
p <- ggplot(dt, aes(x =reorder(MEP, Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm), y = Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm))+
  geom_errorbar(aes(ymin=Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm-Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm_SE, ymax=Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm+Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm_SE), width=.01, colour="black") +
...
setkey(dt, Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm)
datatable(format(dt[,list(MEP,Barcode, Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm,Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm_SE,Spot_PA_ReplicateCount)], digits=1, scientific = FALSE, nsmall=0), options = list(pageLength = 5), colnames = c("MEP", "Barcode", "MitoTracker Int.", "MitoTracker Int. SE", "Replicate Count"))

if(!analysisVersion=="v1"){
  setkey(l3HF, Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm)
  datatable(format(l3HF[,list(MEP,Barcode,OmeroDetailURL,ArrayRow,ArrayColumn, Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm,Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker_RZSNorm_SE,Spot_PA_ReplicateCount)], digits=1, scientific = FALSE, nsmall=0), options = list(pageLength = 5), colnames = c("MEP", "Barcode","Omero", "Row","Column","MitoTracker Int.", "MitoTracker Int. SE", "Replicate Count"),escape = FALSE)
}
```
...
p <- ggplot(dt, aes(x=Nuclei_PA_Gated_EduPositiveLogit_RZSNorm))+geom_bar(binwidth = .05)+
...
p <- ggplot(dt, aes(x = reorder(Ligand, Nuclei_PA_Gated_EduPositiveLogit_RZSNorm, FUN=median), y = Nuclei_PA_Gated_EduPositiveLogit_RZSNorm, colour = Barcode))+geom_boxplot()+
...
p <- ggplot(dt, aes(x = reorder(ECMpAnnotID, Nuclei_PA_Gated_EduPositiveLogit_RZSNorm, FUN=median), y = Nuclei_PA_Gated_EduPositiveLogit_RZSNorm))+geom_boxplot()+
...
p <- ggplot(dt, aes(x =reorder(MEP, Nuclei_PA_Gated_EduPositiveLogit_RZSNorm), y = Nuclei_PA_Gated_EduPositiveLogit_RZSNorm))+
  geom_errorbar(aes(ymin=Nuclei_PA_Gated_EduPositiveLogit_RZSNorm-Nuclei_PA_Gated_EduPositiveLogit_RZSNorm_SE, ymax=Nuclei_PA_Gated_EduPositiveLogit_RZSNorm+Nuclei_PA_Gated_EduPositiveLogit_RZSNorm_SE), width=.01, colour="black") +
...
setkey(dt, Nuclei_PA_Gated_EduPositiveLogit_RZSNorm)
datatable(format(dt[,list(MEP,Barcode, Nuclei_PA_Gated_EduPositiveLogit_RZSNorm,Nuclei_PA_Gated_EduPositiveLogit_RZSNorm_SE,Spot_PA_ReplicateCount)], digits=1, scientific = FALSE, nsmall=0), options = list(pageLength = 5), colnames = c("MEP", "Barcode", "EDU+ Prop.", "EDU+ Prop. SE", "Replicate Count"))

if(!analysisVersion=="v1"){
  setkey(l3HF, Nuclei_PA_Gated_EduPositiveLogit_RZSNorm)
  datatable(format(l3HF[,list(MEP,Barcode,OmeroDetailURL,ArrayRow,ArrayColumn, Nuclei_PA_Gated_EduPositiveLogit_RZSNorm,Nuclei_PA_Gated_EduPositiveLogit_RZSNorm_SE,Spot_PA_ReplicateCount)], digits=1, scientific = FALSE, nsmall=0), options = list(pageLength = 5), colnames = c("MEP", "Barcode","Omero", "Row","Column","EDU+ Prop.", "EDU+ Prop. SE", "Replicate Count"),escape = FALSE)
}
```
...
p <- ggplot(dt, aes(x=Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm))+geom_bar(binwidth = .02)+
  #geom_vline(xintercept = c(-2,2), colour = "blue")+
...
p <- ggplot(dt, aes(x = reorder(Ligand, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm, FUN=median), y = Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm, colour = Barcode))+geom_boxplot()+
...
p <- ggplot(dt, aes(x = reorder(ECMpAnnotID, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm, FUN=median), y = Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm))+geom_boxplot()+
...
p <- ggplot(dt, aes(x =reorder(MEP, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm), y = Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm))+
  geom_errorbar(aes(ymin=Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm-Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm_SE, ymax=Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm+Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm_SE), width=.01, colour="black") +
...
setkey(dt, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm)
datatable(format(dt[,list(MEP,Barcode, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm,Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm_SE,Spot_PA_ReplicateCount)], digits=1, scientific = FALSE, nsmall=0), options = list(pageLength = 5), colnames = c("MEP", "Barcode", "Lineage Ratio", "Lineage Ratio SE", "Replicate Count"))

if(!analysisVersion=="v1"){
  setkey(l3HF, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm)
  datatable(format(l3HF[,list(MEP,Barcode,OmeroDetailURL,ArrayRow,ArrayColumn, Cytoplasm_PA_Intensity_LineageRatio_RZSNorm,Cytoplasm_PA_Intensity_LineageRatio_RZSNorm_SE,Spot_PA_ReplicateCount)], digits=1, scientific = FALSE, nsmall=0), options = list(pageLength = 5), colnames = c("MEP", "Barcode","Omero", "Row","Column","LineageRatio", "LineageRatio SE", "Replicate Count"),escape = FALSE)
}
```
...
df <- dcast(data.frame(l4F[,list(ECMp,Ligand,Spot_PA_SpotCellCount_RZSNorm_RobustZ)]),ECMp~Ligand, value.var = "Spot_PA_SpotCellCount_RZSNorm_RobustZ")

rownames(df) <- df$ECMp
df <- df[,!(names(df) %in% c("ECMp"))]

d3heatmap(df, scale="column", colors=hmcols, xaxis_font_size="6pt", yaxis_font_size="6pt")
```
...
datatable(format(dt[, list(ECMp, Ligand,Barcode,Spot_PA_SpotCellCount_RZSNorm_RobustZ, Spot_PA_SpotCellCount, Spot_PA_ReplicateCount)], digits=1, scientific = FALSE, nsmall=0), options = list(pageLength = 5), colnames = c("ECMp","Ligand","Barcode","Spot Cell Count Z Score","Spot Cell Count","Replicate Count"))
...
#set min and max outlier values
