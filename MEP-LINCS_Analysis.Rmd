...
p <- ggplot(l4HF, aes(x =reorder(MEP, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm), y = Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm))+
...
setkey(l4HF, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm)
datatable(format(l4HF[,list(MEP,Barcode, Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm,Cytoplasm_PA_Intensity_LineageRatioLog2_RZSNorm_SE,Spot_PA_ReplicateCount)], digits=1, scientific = FALSE, nsmall=0), options = list(pageLength = 5), colnames = c("MEP", "Barcode", "Lineage Ratio", "Lineage Ratio SE", "Replicate Count"))
...
The following heatmap shows the normalized MEP responses based on the curated feature vector and the normalized dataset.    
...
d3heatmap(fvDT, scale="column", colors=hmcols, xaxis_font_size="6pt", yaxis_font_size="4pt")
...
d3heatmap(l4pcvDT, scale="column", colors=hmcols, xaxis_font_size="6pt", yaxis_font_size="4pt")
```
...
##Spectral Overlap
The following plots are intended to show if there is overlap between the channels.
