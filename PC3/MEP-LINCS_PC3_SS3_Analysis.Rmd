...
p <- ggplot(dt, aes(x=Cytoplasm_PA_Intensity_LineageRatio_RZSNorm_RobustZ))+geom_bar(binwidth = .1)+
...
p <- ggplot(dt, aes(x=Nuclei_PA_AreaShape_Neighbors_RZSNorm,
...
kable(dt[dt$Spot_PA_SpotCellCount_RZSNorm_RobustZ >=2, list(Ligand,ECMp,Spot_PA_SpotCellCount_RZSNorm_RobustZ, Spot_PA_SpotCellCount, Spot_PA_ReplicateCount)],digits = 2, col.names = c("Ligand","ECMp","Spot Cell Count Z Score","Spot Cell Count","Replicate Count"))
```
