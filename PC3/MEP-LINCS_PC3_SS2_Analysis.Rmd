...
```{r ProliferationResponseLigand, fig.width=8,  fig.height=6, echo=FALSE}
...
```{r ProliferationResponseECMp, fig.width=8,  fig.height=6, echo=FALSE}
...
p <- ggplot(data.frame(l4PCAModel$x), aes(x = PC1, y = PC2, col = l4F$Cytoplasm_CP_Intensity_MedianIntensity_Edu_RZSNorm)) +
  geom_point(size = rel(.8), alpha = .8) +
...
```{r ActiveMeps, echo = FALSE, eval=FALSE}
