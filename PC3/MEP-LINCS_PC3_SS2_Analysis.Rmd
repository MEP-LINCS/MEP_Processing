...
p <- ggplot(dt, aes(x=Nuclei_PA_Gated_EduPositiveProportion_RZSNorm))+geom_bar(binwidth = .01)+
...
p <- ggplot(dt[!dt$Nuclei_PA_Gated_EduPositiveProportion_RZSNorm==0], aes(x = reorder(Ligand, Nuclei_PA_Gated_EduPositiveProportion_RZSNorm, FUN=median), y = Nuclei_PA_Gated_EduPositiveProportion_RZSNorm, colour = Barcode))+geom_boxplot()+
...
p <- ggplot(dt, aes(x = reorder(ECMp, Nuclei_PA_Gated_EduPositiveProportion_RZSNorm, FUN=median), y = Nuclei_PA_Gated_EduPositiveProportion_RZSNorm))+geom_boxplot()+
