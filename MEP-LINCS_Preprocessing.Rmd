...
#Previous location for normalizing the dataset
#################
...
if(ss %in% c("SS1")){
  ...
  cDT <- cDT[,EduPositiveProportion := sum(Nuclei_PA_Gated_EduPositive)/length(ObjectNumber),by="Barcode,Well,Spot"]
...
```{r MEPLevelData, echo=FALSE}
  ...
  mDT <- slDT[,list(Well,CellLine,Ligand,Barcode,Endpoint488,Endpoint555,Endpoint647,EndpointDAPI,ECMp),keyby="LigandAnnotID,ECMpAnnotID,Barcode"]
