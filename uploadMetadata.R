...
createAnnotations <- function(studyName, path) {
  ...
  metadataFiles <- data.frame(filename = paste0(path,"/",barcodes,"/Analysis/",barcodes,"_an2omero.csv"),
                              Consortia="MEP-LINCS",
                              DataType="Metadata",
...
metadataFiles <- createAnnotations(studyName = "MCF10A_SS1", path = "/lincs/share/lincs_user")
