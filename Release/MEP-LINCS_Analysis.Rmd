...
l3 <- fread(paste0("../AnnotatedData/",datasetName, "_",ss,"_Level3.txt"), showProgress = FALSE)
l4 <- fread(paste0("../AnnotatedData/",datasetName, "_",ss,"_Level4.txt"), showProgress = FALSE)
...
#MEP-LINCS `r datasetName` `r ss` Analysis  
####date: `r Sys.Date()`
...
if (grepl("SS2|SS4|SSA|SSE|SSF",ss)){
...
} else if (any(grepl("SS2|SS4|SS6|SSA",ss))){
...
```{r, child='MEP-LINCS_ProliferationText.Rmd', eval=grepl("SS2|SS4|SSE|SSA",ss)}
```



```{r NormedProliferationByMEPFull,eval=grepl("SS2|SS4|SS6|SSA|SSE|SSF",ss), fig.width=8, fig.height=6}
...
```{r, child='MEP-LINCS_ProliferationHeatMapsText.Rmd', eval=grepl("SS2|SS4|SSA|SSE|SSF",ss)}
```


```{r EdUHeatmapFull, fig.width=8, fig.height=5, eval=grepl("SS2|SS4|SS6|SSA|SSE|SSF",ss)}
...
```{r EdUBoxplotsFull, fig.width=12, fig.height=5, eval=grepl("SS2|SS4|SS6|SSA|SSE|SSF",ss)}
...
```{r NormedNestinByMEP,eval=grepl("SSE",ss), fig.width=8, fig.height=6}
...
```{r NestinHeatmapFull, fig.width=8, fig.height=5, eval=grepl("SSE",ss)}
...
```{r NestinBoxplotsFull, fig.width=12, fig.height=5, eval=grepl("SSE",ss)}
