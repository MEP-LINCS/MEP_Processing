...
if(any(grepl("SS1",ss))){
  ...
  if (cellLine=="MCF10A"){
    colNames <- c("MEP", "ECMp", "Ligand", "Spot_PA_SpotCellCountLog2RUV", "Spot_PA_SpotCellCount","Nuclei_PA_Cycle_DNA2NProportionLogitRUV","Cytoplasm_PA_Intensity_LineageRatioLog2RUV", "Spot_PA_ReplicateCount")
