...
```{r MitotrackerHeatmapFull, eval=grepl("SS1",StainingSet), fig.width=8, fig.height=5}
...
```{r NormedProliferationByMEPFull,eval=grepl("SS2|SS4|SS6|SSA|SSE|SSF",StainingSet), fig.width=8, fig.height=6}
