...
p <- ggplot(l4F, aes(x=Ligand, y=btLogit(Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess)))+
...
p <- ggplot(dt, aes(x=Cytoplasm_PA_Intensity_LineageRatioLog2RUV3Loess, y = btLogit(Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess), colour = Ligand))+
  geom_point(alpha=.5)+
  guides(colour=FALSE)+
