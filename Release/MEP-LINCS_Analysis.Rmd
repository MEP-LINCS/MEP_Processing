...
```{r NormedProliferationByMEPFull,eval=grepl("SS2|SS4|SS6|SSF",ss), fig.width=8, fig.height=6}
...
```{r, child='MEP-LINCS_ProliferationHeatMapsText.Rmd', eval=grepl("SS2|SS4|SSF",ss)}
```


```{r EdUHeatmapFull, fig.width=8, fig.height=5, eval=grepl("SS2|SS4|SS6|SSF",ss)}
...
```{r EdUBoxplotsFull, fig.width=8, fig.height=5, eval=grepl("SS2|SS4|SS6|SSF",ss)}
