...
```{r rawEdUHistograms, fig.width=3.7,fig.height=4, eval=exists("l1")&grepl("SS2|SS4|SS6|SSD|SSE",ss)}
...
```{r Cell_cycle_plots,echo=FALSE, fig.width=8, fig.height=5, eval=exists("l1")&grepl("SS2|SS4|SS6|SSD|SSE",ss)}
binwidth=.04
for (barcode in barcodes){
  setkey(l1S, Barcode)
  dtb <- l1S[barcode]
