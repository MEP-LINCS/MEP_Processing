...
l1SDTL <- lapply(barcodes, function(barcode, path){
...
```{r gatedKRT5Ligandboxplots, fig.width=10,fig.height=4, eval=length(setdiff(c("Cytoplasm_CP_Intensity_MedianIntensity_KRT5","Cytoplasm_PA_Gated_KRT19Positive"),colnames(l1S)))==0}

p <- ggplot(l1S, aes(x=factor(Ligand),y=log2(Cytoplasm_CP_Intensity_MedianIntensity_KRT5), colour=factor(Cytoplasm_PA_Gated_KRT19Positive)))+
