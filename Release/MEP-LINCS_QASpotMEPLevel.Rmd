...
```{r rawEdUBoxplots, fig.height=5, eval=grepl("SS2|SS6",ss)}
...
```{r rawKrt19Boxplots, fig.height=5, eval=grepl("SS3|SS6",ss)}
...
```{r ProliferationHistogramFull, eval=grepl("SS2|SS6",ss)}
...
```{r ProliferationByLigandFull, eval=grepl("SS2|SS6",ss)}
...
```{r ProliferationByECMpFull,eval=grepl("SS2|SS6",ss)}
...
```{r ProliferationHistogram, eval=grepl("SS2|SS6",ss)}
...
```{r ProliferationByLigand, eval=grepl("SS2|SS6",ss)}
...
```{r ProliferationByECMp,eval=grepl("SS2|SS6",ss)}
...
```{r Content Layout,echo=FALSE, message=FALSE, warnings=FALSE, fig.width=7, eval=exists("l3")}
...
```{r, , fig.height=10, eval=grepl("SS2|SS6",ss)}
