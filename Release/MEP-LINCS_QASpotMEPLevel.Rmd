...
```{r, child='MEP-LINCS_MitoText.Rmd', eval=any("MitoTracker",colnames(l3))}
```



```{r rawMitoBoxplots, fig.height=5,  eval=any("MitoTracker",colnames(l3))}
...
```{r rawcaspaseBoxplots, fig.height=5,  eval=any("CaspaseLog2",colnames(l3))}
...
```{r rawCaspaseBoxplots, fig.height=5,  eval=any("Caspase",colnames(l3))}
...
```{r, , fig.height=10,  eval=any("EdUPositiveProportion",colnames(l3))}
