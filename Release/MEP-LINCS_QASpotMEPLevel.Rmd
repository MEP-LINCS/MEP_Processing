...
```{r ProliferationByLigandandKRT19Full, eval=grepl("SS4",ss)}
...
```{r Layout Replicate Count,echo=FALSE, message=FALSE, warnings=FALSE, fig.width=6.5, fig.height=3, eval=exists("l3")}
