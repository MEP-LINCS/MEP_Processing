...
l3 <- shortenHA(fread(paste0("../AnnotatedData/",cellLine, "_",ss,"_Level3.txt"), showProgress = FALSE))
l4 <- shortenHA(fread(paste0("../AnnotatedData/",cellLine, "_",ss,"_Level4.txt"), showProgress = FALSE))
...
```{r, child='MEP-LINCS_EdUText.Rmd', eval=grepl("SS2|SS4|SS6|SSE",ss)}
```

<br>

```{r rawEdUBoxplots, fig.height=5, eval=grepl("SS2|SS4|SS6|SSD|SSE",ss)}
...
```{r rawKrt5Boxplots, fig.height=5, eval=grepl("SS3|SS4",ss)}
...
```{r CaspaseByLigand, eval=grepl("SS1",ss)}
...
```{r CaspaseByECMp, eval=grepl("SS1",ss)}
