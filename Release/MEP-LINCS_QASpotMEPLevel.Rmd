...
```{r ProliferationHistogramFull, eval=grepl("SS2|SS4|SS6|SSA",ss)}
...
```{r ProliferationByLigandFull, eval=grepl("SS2|SS4|SS6|SSA|SSD",ss)}
...
```{r ProliferationByECMpFull,eval=grepl("SS2|SS4|SS6|SSA|SSD",ss)}
