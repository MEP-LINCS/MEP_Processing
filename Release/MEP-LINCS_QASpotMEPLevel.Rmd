...
```{r rawEdUBoxplots, fig.height=5, eval=grepl("SS2|SS4|SS6",ss)}
...
setkey(l4F,"Ligand")
p <- ggplot(dt, aes(x = reorder(Ligand, Spot_PA_SpotCellCountLog2RUVLoess, FUN=median), y = Spot_PA_SpotCellCountLog2RUVLoess, colour = Barcode))+geom_boxplot()+
...
```{r ProliferationByLigandFull, eval=grepl("SS2|SS4|SS6",ss)}
...
```{r ProliferationByECMpFull,eval=grepl("SS2|SS4|SS6",ss)}
...
```{r, , fig.height=10, eval=grepl("SS2|SS4|SS6",ss)}
