...
l3 <- shortenHA(fread(paste0("../AnnotatedData/",cellLine, "_",ss,"_",drug,"_",rawDataVersion,"_",analysisVersion,"_Level3.txt"), showProgress = FALSE))
l4 <- shortenHA(fread(paste0("../AnnotatedData/",cellLine, "_",ss,"_",drug,"_",rawDataVersion,"_",analysisVersion,"_Level4.txt"), showProgress = FALSE))
...
if (grepl("SS2",ss)){
  ...
  l4F <- l4F[,Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess_RobustZ := RZScore(Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess)]
}
...
p <- ggplot(dt, aes(x=Cytoplasm_CP_Intensity_MedianIntensity_MitoTrackerLog2RUV3Loess))+geom_histogram(binwidth = .01)+
...
p <- ggplot(dt, aes(x = reorder(Ligand, Cytoplasm_CP_Intensity_MedianIntensity_MitoTrackerLog2RUV3Loess, FUN=median), y = Cytoplasm_CP_Intensity_MedianIntensity_MitoTrackerLog2RUV3Loess, colour = Barcode))+geom_boxplot()+
...
p <- ggplot(dt, aes(x = reorder(ECMp, Cytoplasm_CP_Intensity_MedianIntensity_MitoTrackerLog2RUV3Loess, FUN=median), y = Cytoplasm_CP_Intensity_MedianIntensity_MitoTrackerLog2RUV3Loess))+geom_boxplot()+
...
p <- ggplot(dt, aes(x=Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess))+geom_histogram(binwidth = .02)+
...
p <- ggplot(dt, aes(x = reorder(Ligand, Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess, FUN=median), y = Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess, colour = Cytoplasm_PA_Gated_KRT19Positive))+geom_boxplot()+
...
p <- ggplot(dt, aes(x = reorder(Ligand, Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess, FUN=median), y = Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess, colour = Barcode))+geom_boxplot()+
  ggtitle(paste("\n\nMEP Normalized, EdU+ Proportion by Ligand (full dataset)"))+
  xlab("")+ylab("")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size=rel(.8)), axis.text.y = element_text(angle = 0, vjust = 0.5, hjust=1, size=rel(1)), plot.title = element_text(size = rel(1)),legend.text=element_text(size = rel(.3)),legend.title=element_text(size = rel(.3)))
suppressWarnings(print(p))
...
p <- ggplot(dt, aes(x = reorder(ECMp, Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess, FUN=median), y = Nuclei_PA_Gated_EdUPositiveProportionLogitRUV3Loess))+geom_boxplot()+
...
if(grepl("SS1",ss)){
  p <- ggplot(data.frame(l4PCAModel$x), aes(x = PC1, y = PC2, col = l4F$Cytoplasm_CP_Intensity_IntegratedIntensity_MitoTrackerLog2RUV3Loess)) +
    geom_point(size = rel(.7), alpha = .8) +
  ...
  p <- ggplot(data.frame(l4PCAModel$x), aes(x = PC1, y = PC2, col = l4F$Cells_CP_AreaShape_PerimeterLog2RUV3Loess)) +
    geom_point(size = rel(.7), alpha = .8) +
  ...
  p <- ggplot(data.frame(l4PCAModel$x), aes(x = PC1, y = PC2, col = l4F$Cytoplasm_PA_Intensity_LineageRatioLog2RUV3Loess)) +
    geom_point(size = rel(.7), alpha = .8) +
  ...
  p <- ggplot(data.frame(l4PCAModel$x), aes(x = PC3, y = PC4, col = l4F$Cytoplasm_PA_Intensity_LineageRatioLog2RUV3Loess)) +
    geom_point(size = rel(.7), alpha = .8) +
    labs(colour = "Lineage Ratio")+
    theme(legend.text=element_text(size = 6))+
    guides(colour = guide_legend(override.aes = list(size=6)))
  ...
  p <- ggplot(data.frame(l4PCAModel$x), aes(x = PC5, y = PC6, col = l4F$Cytoplasm_PA_Intensity_LineageRatioLog2RUV3Loess)) +
    geom_point(size = rel(.7), alpha = .8) +
    labs(colour = "Lineage Ratio")+
    theme(legend.text=element_text(size = 6))+
    guides(colour = guide_legend(override.aes = list(size=6)))
  ...
  p <- ggplot(data.frame(l4PCAModel$x), aes(x = PC7, y = PC8, col = l4F$Cytoplasm_PA_Intensity_LineageRatioLog2RUV3Loess)) +
    geom_point(size = rel(.7), alpha = .8) +
    labs(colour = "Lineage Ratio")+
    theme(legend.text=element_text(size = 6))+
    guides(colour = guide_legend(override.aes = list(size=6)))
