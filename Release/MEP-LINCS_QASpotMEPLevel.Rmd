...
```{r rawMitoBoxplots, fig.height=5, eval=grepl("SS1",StainingSet)}
...
```{r rawcaspaseBoxplots, fig.height=5, eval=grepl("SSD",StainingSet)}
...
```{r rawEdUBoxplots, fig.height=5, eval=grepl("SS2|SS4|SS6|SSA|SSD|SSE|SSF",StainingSet)}
...
```{r rawEdUBoxplotsbyWell, fig.height=5, eval=grepl("SS2|SS4|SS6|SSA|SSD|SSE|SSF",StainingSet)}
...
```{r rawEdUBoxplotsbyLigand, fig.height=5, eval=grepl("SS2|SS4|SS6|SSA|SSD|SSE|SSF",StainingSet)}
...
```{r rawKrt5Boxplots, fig.height=5, eval=grepl("SS3|SS4|SSF",StainingSet)}
...
```{r, , fig.height=10, eval=grepl("SS2|SS4|SS6|SSA|SSD|SSE",StainingSet)}
