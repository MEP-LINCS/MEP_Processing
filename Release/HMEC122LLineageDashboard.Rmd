...
df <- read_tsv("./Data/HMEC122L_SSC_Level4.txt")
...
```{r}
renderPlotly({
  ggplot(selectedData(), aes(Spot_PA_SpotCellCount, Cytoplasm_PA_Gated_KRT19PositiveProportionRUVLoess, text=MEP))  + geom_point()+
    labs(x="Cells per Spot", y="KRT19 High")+
   theme(axis.text.x = element_text(angle = 0, vjust = 0.5, hjust=1, size=rel(.8)),
