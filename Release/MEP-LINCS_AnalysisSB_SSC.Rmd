...
l3C <- fread(paste0(path,"/",studyName,"/Annotated/",studyName,"_Level3.tsv"), showProgress = FALSE)
#Add Omero IDs
l3C <-addOmeroIDs(l3C)
#Read in the MEP-Level datasset for the cell line
l4C <- fread(paste0(path,"/",studyName,"/Annotated/",studyName,"_Level4.tsv"), showProgress = FALSE)
...
l4CU <- unique(l4C)
data_matrix <- scale(as.matrix(l4CU[,NormNames, with=FALSE]))
