...
q <- sprintf("select  id,name,Level,StainingSet,Study,Preprocess from entity WHERE parentId =='%s' AND Level != '1' AND Level != '2' ", reAnnotatedDir)
...
if("Nuclei_PA_Gated_EdUPositiveProportionLogitRUVLoess" %in% colnames(reL4)){
...
if("Nuclei_PA_Gated_EdUPositiveProportionLogitRUVLoess" %in% colnames(reL3)){
