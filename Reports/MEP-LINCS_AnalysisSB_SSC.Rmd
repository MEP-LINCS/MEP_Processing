...
###The Spot Level Interactive Datatable can be filtered on keywords and sorted by values.
Images can be viewed by clicking on the Image Link (Gray lab Omero account needed).  
