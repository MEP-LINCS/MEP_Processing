...
knitr::opts_chunk$set(fig.width=12, fig.height=8,echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE, cache.lazy = FALSE)
...
l1 <- lapply(barcodes, function(barcode){
  df <- read_csv(paste0(path,"/",barcode,"/Analysis/GT1/",barcode,"_level1.csv"),
