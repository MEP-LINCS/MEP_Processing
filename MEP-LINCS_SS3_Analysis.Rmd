...
```
The lineage ratio analysis is run using normalized data. The normalized data is calculated by dividing each lineage ratio by the lineage ratio of its corresponding control well.
...
fvSS1 <- paste("Barcode","MEP",
               "Cytoplasm_CP_Intensity_MedianIntensity_MitoTracker",
