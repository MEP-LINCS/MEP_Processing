...
# Find GAL file
q <- sprintf("select id from file where parentId=='syn4624341' and fileType=='gal' and cell_line=='%s' and staining_set=='%s'", cl, ss)
qr <- synQuery(q)
galId <- qr$file.id

# Find XML file
q <- sprintf("select id from file where parentId=='syn4624341' and fileType=='xml' and cell_line=='%s' and staining_set=='%s'", cl, ss)
qr <- synQuery(q)
xmlId <- qr$file.id
```
...
q <- sprintf("select id,name,well,barcode,dataSubType from file where parentId=='syn4624343' and level==0 and cell_line=='%s' and staining_set=='%s'", cl, ss)
